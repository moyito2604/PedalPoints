...
function SponsorCreateUserPage() {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      const response = await axios.post(REACT_APP_BASEURL + '/sponsor/create', userData, {
        headers: {
      ...
      if (response.data.success) {
        setMessage(`${role === 'driver' ? 'Driver' : 'Sponsor'} user ${username} added successfully! Redirecting to landing page...`);
    ...
    <div className="create-user-container">
      ...
      <form className="create-user-form" onSubmit={handleSubmit}>
        ...
        <div className="button-group">
          ...
          <button type="button" className="cancel-button" onClick={() => navigate('/sponsor/landing')}>Cancel</button>
        </div>
...
export default SponsorCreateUserPage;