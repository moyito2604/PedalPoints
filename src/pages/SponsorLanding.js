...
const SponsorLanding = () => {
    ...
    const navOptions = [
        { title: "Create User", path: "/sponsor/create", icon: "👤" },
        { title: "Manage Users", path: "/sponsor/users", icon: "👥" },
        { title: "Check Applications", path: "/sponsor/applications", icon: "📝" },
        { title: "Manage Catalog", path: "/sponsor/catalog/input", icon: "📋" },
        { title: "Set Time Frame", path: "/sponsor/timeframe", icon: "🕒" },
        { title: "Manage Points", path: "/sponsor/points", icon: "💰" },
        { title: "Reports", path: "/sponsor/reports", icon: "📊" },
        { title: "Purchase for Driver", path: "/sponsor/purchase", icon: "🛒" }
    ];
    ...
    return (
        <div className="user-landing-container">
                ...
                <div className="max-w-7xl mx-auto flex justify-between items-center">
                    <div className="flex items-center">
                        ...
                        <div className="hidden md:flex space-x-6">
                            <button onClick={() => navigate('/sponsor/profile')} className="text-gray-600 hover:text-green-600">Profile</button>
                        </div>
                    </div>
            ...
            <div className="user-landing-content">
                {userData ? (
                    <>
                        <h2 className="dashboard-header">Sponsor Dashboard</h2>
                        <p className="dashboard-welcome">Hello, {userData.firstname} {userData.lastname}</p>
                        
                        <div className="dashboard-grid tiles-5">
