...
const UserLanding = () => {
    ...
    const navOptions = [
        { title: "Driver Application", path: "/user/application/submit", icon: "📝" },
        { title: "Application Statuses", path: "/user/application/status", icon: "📋" },
        { title: "Catalog", path: "/catalog/display", icon: "🛒" },
        { title: "Point History", path: "/user/points", icon: "💰" }
    ];
    ...
    return (
        <div className="user-landing-container">
                ...
                <div className="max-w-7xl mx-auto flex justify-between items-center">
                    <div className="flex items-center">
                        ...
                        <div className="hidden md:flex space-x-6">
                            <button onClick={() => navigate('/user/profile')} className="text-gray-600 hover:text-green-600">Profile</button>
                        </div>
                    </div>
            ...
            <div className="user-landing-content">
                {userData ? (
                    <>
                        <h2 className="dashboard-header">Driver Dashboard</h2>
